...
COPY estates.estate (estate_id, link, area, rooms, display_name, district_number, postal_code, street, lat, lon, construction_year) FROM stdin;
...
CREATE INDEX idx_16561_fk_l_id ON estates.estate USING btree (district_number);
